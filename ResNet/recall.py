...
if __name__=="__main__":
    ...
    train_dataset = datasets.ImageFolder("E:/PythonProject/venv/Tongxing/data/river/train/", transform=data_transform["train"])  # 训练集数据
    train_loader = torch.utils.data.DataLoader(dataset=train_dataset, batch_size=BATCH_SIZE, shuffle=True,
                                               num_workers=2)  # 加载数据

    val_dataset = datasets.ImageFolder("E:/PythonProject/venv/Tongxing/data/river/val/", transform=data_transform["val"])  # 测试集数据
